...
key_hex_strings = [
                    '01 9E 07 DA 4D 34 12 7C 2A DC 69 20 7F 58 4E D3',
                    'B1 A3 E5 13 AB 60 A6 47 AA 2D C4 83 68 21 FD 05',
                    '4C 8A 0C 44 E0 82 B8 6E A7 9C 63 2A 96 4F 5B FF',
                    '35 94 C5 7B 44 B6 AE 0A 14 00 04 F0 9E 48 12 6D',
                    '07 10 20 60 E9 25 EF B7 A5 D3 82 FF 9F 95 93 8F',
                    '48 56 C5 64 5A B0 FC D9 58 BF DA F3 0D 80 30 AB',
                    'EA EE EE 12 5F 18 BD BE 15 FB 87 08 CC 60 1F 88',
                    '23 09 49 CC B2 FD 22 45 55 D4 7C C7 40 DF 56 E5',
                    ]
...
for key_index in range(len(key_hex_strings)):
    key = bytes.fromhex(key_hex_strings[key_index].replace(' ', ''))
